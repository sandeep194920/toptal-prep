...
console.log(
  JSON.stringify(result1) === JSON.stringify([0, 1])
    ? "✅ PASS\n"
    : "❌ FAIL\n",
);
...
console.log(
  JSON.stringify(result2) === JSON.stringify([1, 2])
    ? "✅ PASS\n"
    : "❌ FAIL\n",
);
...
console.log("Expected: [0, 1]");
console.log(
  JSON.stringify(result3) === JSON.stringify([0, 1])
    ? "✅ PASS\n"
    : "❌ FAIL\n",
);
...
console.log(
  JSON.stringify(result4) === JSON.stringify([2, 4])
    ? "✅ PASS\n"
    : "❌ FAIL\n",
);
...
console.log(
  JSON.stringify(result5) === JSON.stringify([0, 3])
    ? "✅ PASS\n"
    : "❌ FAIL\n",
);
...
console.log("Expected: [1, 2]");
console.log(
  JSON.stringify(result6) === JSON.stringify([1, 2])
    ? "✅ PASS\n"
    : "❌ FAIL\n",
);
...
console.log("========================================");
console.log(
  "Tip: Check BEFORE adding to map to avoid using same element twice!",
);
